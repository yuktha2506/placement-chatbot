...
VALUES
  ...
  ('salesforce-fullstack', 'Salesforce', 'Product-based', 7.0, JSON_ARRAY('CSE','ISE','IT','ECE'), 0, JSON_ARRAY('JavaScript','REST APIs'), JSON_ARRAY('React','Node.js','SQL','OOP'), 'Full Stack Developer', 'Sample/demo criteria for full-stack placement guidance. Verify official campus notification.'),
  ('atlassian-frontend', 'Atlassian', 'Product-based', 7.0, JSON_ARRAY('CSE','ISE','IT'), 0, JSON_ARRAY('JavaScript','React'), JSON_ARRAY('HTML','CSS','REST APIs','Problem solving'), 'Frontend Engineer', 'Sample/demo criteria for guidance only. Product company shortlisting can vary by role.'),
  ('oracle-appdev', 'Oracle', 'Product-based', 7.0, JSON_ARRAY('CSE','ISE','IT','ECE'), 0, JSON_ARRAY('Java','SQL'), JSON_ARRAY('OOP','DBMS','REST APIs','Cloud basics'), 'Application Developer', 'Sample/demo criteria. Official eligibility can differ by campus and hiring season.'),
